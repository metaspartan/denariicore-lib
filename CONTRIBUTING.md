Contributing to Denariicore
=======

We're working hard to make *denariicore* the most powerful JavaScript library for working with denarius. Our goal is to have *denariicore* be a library that can be used by anyone interested in denarius, and to level expertise differences with great design and documentation.

## Community

If there are any questions, etc., please feel to ask in one of the community channels:

- https://denariustalk.org (Support Forum)
- https://discord.gg/UvzVg (Development Chat)
...
These are some global design goals in denariicore that any change must adhere.
...
When possible, denariicore objects should have standard methods on an instance prototype:
...
`JSON.stringify` and `JSON.parse` are expected to be handled outside of the scope of Denariicore methods. For example, calling `JSON.stringify` on an Denariicore object will behave as expected and call `transaction.toJSON()` and then stringify it:
...
#### T3 - Require 'denariicore' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the denariicore object.

DO:
```javascript
var denariicore = require('../');
var PublicKey = denariicore.PublicKey;
```
DON'T:
```javascript
...
```sh
git remote add carsenk git@github.com:carsenk/denariicore.git
git pull --rebase carsenk master
```
...
```
Finally go to [github.com/carsenk/denariicore](https://github.com/carsenk/denariicore) in your web browser and issue a new pull request.

Main contributors will review your code and possibly ask for changes before your code is pulled in to the main repository.  We'll check that all tests pass, review the coding style, and check for general code correctness. If everything is OK, we'll merge your pull request and your code will be part of denariicore.

If you have any questions feel free to post them to
[github.com/carsenk/denariicore/issues](https://github.com/carsenk/denariicore/issues).
