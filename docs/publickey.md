# Public Key
Represents a denarius public key and is needed to be able to receive denarius, as is usually represented as a denarius [Address](address.md). See the official [Denarius Wiki](https://en.denarius.it/wiki/Technical_background_of_version_1_Denarius_addresses).
...
A public key point should be on the [secp256k1](https://en.denarius.it/wiki/Secp256k1) curve, instantiating a new PublicKey will validate this and will throw an error if it's invalid. To check that a public key is valid:
...
> var compressedPK = denariicore.PublicKey('030589ee559348bd6a7325994f9c8eff12bd'+
...
> var compressedPK2 = new denariicore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = denariicore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
