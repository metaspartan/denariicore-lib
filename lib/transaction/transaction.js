...
/**
 * Retrieve a hexa string that can be used with denariusd's CLI interface
 ...
 * * `disableMoreOutputThanInput`: disable checking if the transaction spends more denariuss than the sum of the input amounts
 * @return {string}
 */
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'https://denariicore.io/api/lib/transaction#serialization-checks';
 ...
 *
 * Can receive, as output information, the output of denariusd's `listunspent` command,
 * and a slightly fancier format recognized by denariicore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a denariicore Address object. The
 * same is true for `script`, which can be a string or a denariicore Script.
 *
 ...
 *
 * // From a pay to public key hash output from denariusd's listunspent
 ...
 *
 * @see {https://github.com/denarius/bips/blob/master/bip-0069.mediawiki}
 * @return {Transaction} this
 */
 ...
 * CheckTransaction in denarius core.
 */
...
/**
 * Analogous to denariusd's IsCoinBase function in transaction.h
 */
