...
/**
 * A denarius transaction script. Each transaction's inputs and outputs
 * has a script that is evaluated to validate it's spending.
 *
 * See https://en.denarius.it/wiki/Script
 *
 * @constructor
...
/**
 * Analogous to denariusd's FindAndDelete. Find and delete equivalent chunks,
...
/**
 * Comes from denariusd's script interpreter CheckMinimalPush function
...
/**
 * Comes from denariusd's script DecodeOP_N function
 * @param {number} opcode
...
/**
 * Comes from denariusd's script GetSigOpCount(boolean) function
