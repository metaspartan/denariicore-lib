 ...
 * numbers for each denarius network. Currently only supporting "livenet"
...
addNetwork({
  ...
  xpubkey: 0x0488b21e,
  xprivkey: 0x0488ade4,
  networkMagic: 0xb4eff2fa,
  port: 33339,
  dnsSeeds: [
    'dnsseed.hashbag.cc',
    'seed.denarius.host',
    'seed.denariusexplorer.org',
    'seed.chainz.cryptoid.info',
    'seed.denarius.tech'
  ]
});
